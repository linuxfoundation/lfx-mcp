...
complete=true, with the current term, its tier and end date alongside. Scope
b2b_org_uid to the organisation's own record from search_b2b_orgs, and
project_uid to the project. Results cover the caller's visible records, as
